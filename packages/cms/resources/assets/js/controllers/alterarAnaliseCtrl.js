cmsApp.controller('alterarAnaliseCtrl', ['$scope', '$http', 'Upload', '$timeout', function($scope, $http, Upload, $timeout){
    ...
    $scope.alterar = function (file, arquivo){
        ...
        if(file==null && arquivo==null){
            ...
            $http.post("cms/alterar-analise/"+$scope.id, {
            ...
            Upload.upload({
                url: 'cms/alterar-analise/'+$scope.id,
                data: data1
                ...
                $scope.mensagemSalvar =  "Gravado com sucesso!";
                $scope.removerImagem = false;
                $scope.imagemBD = '/imagens/analises/'+response.data;
                $scope.processandoSalvar = false;
    ...
    $scope.carregaImagem  = function(img, arquivo) {
        if(img!=''){
            $scope.imagemBD = 'imagens/analises/xs-'+img;
