...
@section('content')
    {!! Html::script('assets-cms/js/controllers/equipeCtrl.js') !!}
<script>
    $(function () {
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div ng-show="totalItens > 0" class="clan-paginacao">
                    <div class="equipe-paginacao">
                        <uib-pagination total-equipes="totalItens" ng-model="currentPage" max-size="maxSize" class="pagination-sm" boundary-equipes="true" force-ellipses="true" equipes-per-page="itensPerPage" num-pages="numPages"></uib-pagination>
                    </div>
                    <div class="equipe-paginacao">
                        <select class="form-control itens-por-pagina equipe-paginacao"  ng-model="itensPerPage">
