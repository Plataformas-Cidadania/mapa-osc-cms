            ...
            <div class="col-md-12">
                <div class="box-padrao">
                    <div class="input-group">
                        ...
                        <input class="form-control" type="text" ng-model="dadoMrosc" placeholder="Faça sua busca"/>
                    </div>
                    <br>
                    ...
                    <table ng-show="totalItens>0" class="table table-striped">
                        ...
                        <tr ng-repeat="mrosc in mroscs">
                            ...
                            <td class="text-right">
                                <div>
                                    {{--<a href="cms/items/<% mrosc.id %>"><i class="fa fa-sitemap fa-2x" title="Itens"></i></a>&nbsp;&nbsp;--}}
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div ng-show="totalItens > 0" class="clan-paginacao">
                    <div class="mrosc-paginacao">
                        <uib-pagination total-mroscs="totalItens" ng-model="currentPage" max-size="maxSize" class="pagination-sm" boundary-links="true" force-ellipses="true" mroscs-per-page="itensPerPage" num-pages="numPages"></uib-pagination>
                    </div>
                    <div class="mrosc-paginacao">
                        <select class="form-control itens-por-pagina mrosc-paginacao"  ng-model="itensPerPage">
