...
@section('content')
    {!! Html::script('assets-cms/js/controllers/alterarAnaliseCtrl.js') !!}
    <div ng-controller="alterarAnaliseCtrl">
        <div class="box-padrao">
            <h1><a href="javascript:history.back();"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Analises</h1>
            <?php //print_r($analise);?>
            <div ng-init="carregaImagem('{{$analise->imagem}}', '{{$analise->arquivo}}')">
                <span class="texto-obrigatorio">* campos obrigatórios</span><br><br>
                {!! Form::model($analise, ['name' =>'form']) !!}
                ...
                <a href="arquivos/analises/<% arquivoBD %>" target="_blank" ng-show="arquivoBD"><% arquivoBD %></a>
                <a ng-show="fileArquivo"><% fileArquivo.name %></a>
                <br><br>

                <br><br>
                @include('cms::analise._form')
                <input type="hidden" name="id" ng-model="id" ng-init="id='{{$analise->id}}'"/>
                <div class="row">
