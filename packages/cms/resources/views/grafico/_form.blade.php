{!! Form::label('tipo_grafico', 'Tipo de Gráfico *') !!}<br>
...
null, ['class'=>"form-control width-medio <% validar(grafico.tipo_grafico) %>", 'ng-model'=>'grafico.tipo_grafico', 'ng-required'=>'true', 'init-model'=>'grafico.tipo_grafico', 'placeholder' => '']) !!}<br>
