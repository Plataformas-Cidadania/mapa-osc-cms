...
@section('content')
    ...
    <div ng-controller="alterarModuloCtrl">
        <div class="box-padrao">
            <h1><a href="cms/modulos"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;Modulos</h1>
            <?php //print_r($modulo);?>
            <div ng-init="carregaImagem('{{$modulo->imagem}}')">
                ...
                <div class="row">
                    <div class="col-md-1 col-lg-1 col-xs-3">
                        <button class="btn btn-info" type="button" ng-click="alterar(picFile)" ng-disabled="form.$invalid && form.modulo.$dirty">Salvar</button>
                    </div>
