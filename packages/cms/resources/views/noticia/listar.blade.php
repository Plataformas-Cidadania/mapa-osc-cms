...
<script>
    ...
    <div ng-controller="noticiaCtrl">
        <div class="box-padrao">
            ...
            <button class="btn btn-primary" ng-click="mostrarForm=!mostrarForm" ng-show="!mostrarForm">Novo Noticia</button>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div ng-show="totalItens > 0" class="clan-paginacao">
                    <div class="noticia-paginacao">
                        <uib-pagination total-noticias="totalItens" ng-model="currentPage" max-size="maxSize" class="pagination-sm" boundary-links="true" force-ellipses="true" noticias-per-page="itensPerPage" num-pages="numPages"></uib-pagination>
                    </div>
                    <div class="noticia-paginacao">
                        <select class="form-control itens-por-pagina noticia-paginacao"  ng-model="itensPerPage">
