cmsApp.controller('alterarTipoGraficoCtrl', ['$scope', '$http', 'Upload', '$timeout', function($scope, $http, Upload, $timeout){
    ...
    $scope.alterar = function (file, arquivo){
        ...
        if(file==null && arquivo==null){
            ...
            $http.post("cms/alterar-tipo-grafico/"+$scope.id, {
                'tipoGrafico': $scope.tipoGrafico,
            ...
            Upload.upload({
                url: 'cms/alterar-tipo-grafico/'+$scope.id,
                data: data1
                ...
                $scope.mensagemSalvar =  "Gravado com sucesso!";
                $scope.removerImagem = false;
                $scope.imagemBD = '/imagens/tipos-graficos/'+response.data;
                $scope.processandoSalvar = false;
    ...
    $scope.carregaImagem  = function(img, arquivo) {
        if(img!=''){
            $scope.imagemBD = 'imagens/tipos-graficos/xs-'+img;
